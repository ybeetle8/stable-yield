...
代码看后几点注意:
1.代码中有:绑定一个“好友地址”作为直推 5% 的接收方。仅作为直推 5% 的收款地址；不影响推荐树结构、KPI 与层级资格
设计取舍与注意 不绑定 friend 的后果：直推 5% 默认给 root
解耦角色与收益渠道：推荐树负责团队层级的“差额奖励”（最高35%），
直推的“固定5%”独立由 friend 接收，避免把两类奖励强耦合到同一地址 市场/运营灵活性：用户可将 5% 指定给实际引荐者防止团队奖励与直推奖励相互干扰：团队奖励要求层级资格、preacher
2.要上ok交易所,币代码上应该不允许有黑白名单, 有这功能会被自动标记为诈骗,你得与项目方沟通一下..
