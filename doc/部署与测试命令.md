...
测试代码:
npx hardhat run scripts/testRootAddressColdStart.js --network localhost
npx hardhat run scripts/testAetherReferral.js --network localhost  

读取老合约地址: 0xBfF0Ab2a2593DC6dFBB6f745B9dB2063EfD6b64B 推荐关系
node scripts/fetchReferralRelationships.js
